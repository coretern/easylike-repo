...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.13.0/css/all.css">
    ...
    <link rel="stylesheet" type="text/css" href="assets/public/admin/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="assets/public/admin/style.css">
...
href="<?php echo site_url("admin/account") ?>"></i><span>
 ...
 <li><a href="#" data-toggle="modal" data-target="#OwnSMMPanel"><i class="	fa fa-question-circle"></i> <b>CRON</b> </a>  </li>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="well">
                        <h4> QUICKPANEL V2.6 </h4>
                        - For Support Contact Us! <br>
                        <b>Email -</b><code> ownsmmpanel@gmail.com</code>
                    </div>
                    <div class="well">
                        <h4>CRON Addresses & Recommended Times</h4> <br>
                        <div>
                            <code id="cron1">FOR ORDERS</code>
                            <button class="btn btn-info btn-sm copy-btn" onclick="copyText('wget --spider -O - <?=site_url()?>crons/orders.php >/dev/null 2>&1')">Copy</button>
                            <br> Set This Cron On Every 1 Min<br><hr>
                        </div>
                        <div>
                            <code id="cron2">FOR REFILL ORDERS</code>
                            <button class="btn btn-info btn-sm copy-btn" onclick="copyText('wget --spider -O - <?=site_url()?>crons/refill.php >/dev/null 2>&1')">Copy</button>
                            <br> Set This Cron On Every 15 Min<br><hr>
                        </div>
                        <div>
                            <code id="cron3">FOR SELLER SYNC</code>
                            <button class="btn btn-info btn-sm copy-btn" onclick="copyText('wget --spider -O - <?=site_url()?>crons/seller-sync.php >/dev/null 2>&1')">Copy</button>
                            <br> Set This Cron On Every 5 Min<br><hr>
                        </div>
                        <div>
                            <code id="cron4">FOR AVERAGE TIME</code>
                            <button class="btn btn-info btn-sm copy-btn" onclick="copyText('wget --spider -O - <?=site_url()?>crons/average.php >/dev/null 2>&1')">Copy</button>
                            <br> Set This Cron On Every 1 Min<br><hr>
                        </div>
                        <div>
                            <code id="cron5">FOR SUPPORT AUTOREPLY</code>
                            <button class="btn btn-info btn-sm copy-btn" onclick="copyText('wget --spider -O - <?=site_url()?>crons/autoreply.php >/dev/null 2>&1')">Copy</button>
                            <br> Set This Cron On Every 1 Min<br><hr>
                        </div>
                        <div>
                            <code id="cron6">FOR DRIPFEED ORDERS</code>
                            <button class="btn btn-info btn-sm copy-btn" onclick="copyText('wget --spider -O - <?=site_url()?>crons/dripfeed.php >/dev/null 2>&1')">Copy</button>
                            <br> Set This Cron On Every 1 Min<br><hr>
                        </div>
                        <div>
                            <code id="cron7">FOR PAYMENTS LOG</code>
                            <button class="btn btn-info btn-sm copy-btn" onclick="copyText('wget --spider -O - <?=site_url()?>crons/payments.php >/dev/null 2>&1')">Copy</button>
                            <br> Set This Cron On Every 1 Min<br><hr>
                        </div>
                        <div>
                            <code id="cron8">FOR AUTOLIKE ORDERS</code>
                            <button class="btn btn-info btn-sm copy-btn" onclick="copyText('wget --spider -O - <?=site_url()?>crons/autolike.php >/dev/null 2>&1')">Copy</button>
                            <br> Set This Cron On Every 1 Min<br>
                        </div>
                    </div>
                </div>
