...
<html lang="en">
  <head>
      <!-- 
      Buy SMM Panel Script From [ OwnSMMPanel.in ] 
      Contact Us : +91 8355965199
      For Free SMM Panel Scripts and Codes Visit [ WebTechz.co ]
      Thank You..!
      ---->
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title>Admin Panel - OwnSMMPanel</title>
...
.ic-account {
  ...
  background-image: url(https://ownsmmpanel.in/ownsmmpanel/images/favicon.png);
...
<input class="login-form-input two_factor_input" type="number" name="two_factor_code"  placeholder="Enter Code">
