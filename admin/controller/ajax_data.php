...
elseif ($action == "pay_rent"):
  if (!$_POST["state"]) {
    ...
    $amount = "500.00";
    if (!$_SESSION["upi"]) {
      $upi = "upi://pay?pa=&pn=Paytm%20Merchant&am=$amount&mam=$amount&tn=Monthly%20Rent%20Payment&tr=$txn_id";
      $_SESSION["upi"] = $upi;
    }
...
';
    ...
    if ($resp["STATUS"] == "TXN_SUCCESS") {
      ...
      $to1 = "ownsmmpanel@gmail.com";
      $fromName = $_SERVER["HTTP_HOST"];
      $from = "noreply@ownsmmpanel.in";

      $subject = "Rent Payment : " . $_SERVER["HTTP_HOST"] . "";
      $mail->IsSMTP();
      $mail->CharSet = 'UTF-8';
      $mail->Host = "mail.ownsmmpanel.in";
      $mail->SMTPDebug = 0;
      $mail->SMTPAuth = true;
      $mail->Port = 587;
      $mail->Username = $from;
...
<span class="services-import__packages-price-edit" >';
  ...
  $return .= '</div>
            ...
            <script src="' . site_url("assets/public/admin/") . 'jquery.tinytoggle.min.js"></script>
            <link rel="stylesheet" type="text/css" href="' . site_url("assets/public/admin/") . 'tinytoggle.min.css" rel="stylesheet">
            <script>
...
<div class="service-mode__block">
          ...
          <script src="';
  $return .= site_url('assets/public/admin/');
...
elseif ($action == "download_category_icon_images"):
  ...
  "pin": "https://i.postimg.cc/05G3cRfF/pin.png"
    ...
    foreach ($array_of_images as $name => $link) {
      ...
      $db_link = site_url("assets/img/files/" . $save_name . ".png");
      file_put_contents($_SERVER["DOCUMENT_ROOT"] . "/assets/img/files/" . $save_name . ".png", $binary_image);
...
elseif ($action == "subscriptions_expiry"):
  ...
  $return .= '" name="expiry">
          ...
          <link rel="stylesheet" type="text/css" href="' . site_url("assets/public/") . 'datepicker/css/bootstrap-datepicker3.min.css">
          <script type="text/javascript" src="' . site_url("assets/public/") . 'datepicker/js/bootstrap-datepicker.min.js"></script>
          <script type="text/javascript" src="' . site_url("assets/public/") . 'datepicker/locales/bootstrap-datepicker.tr.min.js"></script>
          ';
