...
$redirect_uri = site_url("https://smmpanelscript.in");
...
exit();
 ...
 $pass = openssl_random_pseudo_bytes(16);
  ...
  $insert = $conn->prepare("INSERT INTO clients SET name=:name, username=:name, email=:email, password=:pass, lang=:lang, telephone=:phone, register_date=:date, apikey=:key , ref_code=:ref_code, email_type=:type, balance=:spent, spent=:spent,currency_type=:currency_type");
